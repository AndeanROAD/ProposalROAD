...
\item{\bf Implementation}: Define the infrastructure and budget
  required to offer Massive Open Onlinde Courses. These courses will be built by
  researchers in the Andean ROAD and will be offered in Spanish. After
  this first step we will prepare one course as a pilot for this
  experience and find the required funding to implement it.
\item{\bf Budget}: 0KEuro/Year for the planning phase.
\end{itemize}
...
\begin{itemize}
\item Task Force 1: 30 KEuro/year
